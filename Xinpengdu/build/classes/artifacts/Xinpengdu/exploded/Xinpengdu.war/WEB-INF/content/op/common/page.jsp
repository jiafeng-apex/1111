...
<div class="page">
	<div class="pagination pagination-large fr">
		...
		<div class="numgo fl">
			<span>第：<input type="text" style="text-align:center;"  id="targetPage" name="targetPage" value="${page.pageNo}" class="numpage" onkeydown="if (event.keyCode === 13) {health.jumpTarget(document.getElementById('targetPage').value,${page.totalPages});}"> 页</span>
			<a href="javascript:void(0)" onClick="javascript:health.jumpTarget(document.getElementById('targetPage').value,${page.totalPages})" class="btn gobtn inquiry">GO</a>
		</div>
	</div>
</div>
